...
export default function ProjectsHero() {
  return (
    <section   className="flex flex-col md:flex-row items-center justify-between px-8 md:px-16 pt-10 container mx-auto font-['Poppins'] min-h-[600px]"
  style={{
    ...
    >
      {/* Text Content */}
      <div className="md:w-1/2 text-left mb-10 md:mb-0 relative -top-6 md:left-6">
        <h1 className="text-5xl font-bold text-[#F05A28] mb-4 leading-tight">
          Our Stories in Motion
        </h1>
        <p className="text-[#41423A] text-lg mb-6 dark:text-white">
