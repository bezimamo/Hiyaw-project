  ...
  return (
    <div className="relative bg-white dark:bg-[#41423A] text-[#41423A] dark:text-white min-h-screen">
      ...
      <section className="text-center px-6 py-8">
        ...
        <p className="text-lg">We&#39;d love to hear from you. Please fill out the form below or contact us directly.</p>
      </section>
      ...
      <section className="flex justify-center px-6 py-8">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 w-full max-w-6xl">
          ...
          {/* Contact Info */}
          <div className="space-y-6 text-[#41423A] dark:text-white">
